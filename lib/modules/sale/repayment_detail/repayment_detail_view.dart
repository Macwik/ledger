...
class RepaymentDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TitleBar(
          title: '收款单详情',
          actionWidget: GetBuilder<RepaymentDetailController>(
              id: 'repayment_title',
              builder: (_) {
                return PermissionWidget(
                    permissionCode: state.customType == CustomType.CUSTOM.value
                        ...
                        : PermissionCode
                            .supplier_custom_repayment_detail_delete_permission,
                    child: Visibility(
                ...
                return Column(
                  children: [
                    Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                                DecimalUtil.formatAmount((state
                                            .repaymentDetailDTO?.totalAmount ??
                                        Decimal.zero) -
                                    (state.repaymentDetailDTO?.discountAmount ??
                                        Decimal.zero)),
                                style: TextStyle(
                                  color: state.repaymentDetailDTO?.invalid ==
                            ...
                            Offstage(
                              offstage:
                                  state.repaymentDetailDTO?.discountAmount ==
                                      Decimal.zero,
                              child: Text(
                                '(还款总额: ${DecimalUtil.formatAmount(state.repaymentDetailDTO?.totalAmount)} - 抹零: ${DecimalUtil.formatAmount(state.repaymentDetailDTO?.discountAmount)})',
                                style: TextStyle(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      DateUtil.formatDefaultDate2(state
                                          .repaymentDetailDTO?.repaymentDate),
                                      style: TextStyle(
                                        color: Colours.text_999,
                                        fontSize: 30.sp,
                                        fontWeight: FontWeight.w400,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: state.repaymentDetailDTO
                                                      ?.invalid ==
                                                  IsDeleted.DELETED.value
                                              ? Colours.text_ccc
                                              : Colours.text_333,
                    ...
                    Container(
                      ...
                      padding:
                          EdgeInsets.only(left: 40.w, top: 32.w, bottom: 32.w),
                      child: Text(
                        '还款详情',
                        style: TextStyle(
                            color: state.repaymentDetailDTO?.invalid ==
                    ...
                    state.repaymentDetailDTO?.repaymentBindOrderList?.isEmpty ??
                            true
                    ...
                    Visibility(
                        visible: state.repaymentDetailDTO?.remark?.isNotEmpty ??
                            false,
                        child: Card(
                            elevation: 6,
                            shadowColor: Colors.black45,
