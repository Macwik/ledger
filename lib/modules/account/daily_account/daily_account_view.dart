                  ...
                  Column(
                    children: [
                      Container(
                          ...
                          child: InkWell(
                            onTap: () =>
                                controller.pickerSaleMoneyDate(context),
                      ...
                      GetBuilder<DailyAccountController>(
                          ...
                          builder: (_) {
                            return Expanded(
                              child: controller.state.salesMoneyStatisticDTO
                                          ?.paymentList?.isEmpty ??
                                      true
                                  ? EmptyLayout(hintText: '什么都没有'.tr)
                                  : ListView.separated(
                                      itemBuilder: (context, index) {
                                        var moneyPayment = controller
                                            .state
                          ...
                          builder: (_) {
                            return Flexible(
                              child: controller
                                      ...
                                      null
                                  ? LottieIndicator()
                                  : controller.state.salesProductStatisticsDTO
                                              ?.isEmpty ??
                                          true
                                      ? EmptyLayout(hintText: '什么都没有'.tr)
                                      : ListView.separated(
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                  child: Text(
                                                                DecimalUtil.formatAmount((salesProductStatisticsDTO.totalAmount ?? Decimal.zero) -
                                                                    (salesProductStatisticsDTO
                                                                            .discountAmount ??
                                                                        Decimal
                                                                            .zero) -
                  ...
                  Column(
                    children: [
                      Container(
                          ...
                          child: InkWell(
                            onTap: () =>
                                controller.pickerCreditMoneyDate(context),
                            child: GetBuilder<DailyAccountController>(
                      ...
                      GetBuilder<DailyAccountController>(
                          ...
                          builder: (_) {
                            return Flexible(
                              child:
                                  controller.state.customCreditDTO?.isEmpty ??
                                          true
                                      ? EmptyLayout(hintText: '什么都没有'.tr)
                                      : ListView.separated(
                                          itemBuilder: (context, index) {
                                            var customCreditDTO = controller
                                                .state.customCreditDTO![index];
                                            return InkWell(
                                              onTap: () =>
                                                  controller.toSalesDetail(
                                                      customCreditDTO),
                                              child: Container(
                                                width: double.maxFinite,
                                                alignment: Alignment.centerLeft,
