...
import 'package:ledger/widget/dialog_widget/update_dialog/app_update_binding.dart';
...
class AppUpdateDialog extends StatelessWidget {
  ...
  AppUpdateDialog({required this.appCheckDTO, required this.force}) {
    AppUpdateBinding().dependencies();
    appUpdateController = Get.find<AppUpdateController>();
  }
                                          ...
                                          (OtaEvent event) {
                                            if (event.status ==
                                              ...
                                              appUpdateController.update(
                                                  ['app_update_processor']);
                                            } else if (event.status ==
                                                OtaStatus.INSTALLING) {
                                              appUpdateController.started =
                                                  false;
                                              Get.back();
                                            }
                                          },
